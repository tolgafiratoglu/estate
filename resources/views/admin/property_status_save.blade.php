...
@section('content')
    ...
    <div class="form-group">
        ...
        <input type="text" value='{{ !$new ? $data["name"] : "" }}' class="form-control" id="property_status_name" aria-describedby="propertyStatusHelp" placeholder="{{ __('admin.should_not_be_empty') }}">
