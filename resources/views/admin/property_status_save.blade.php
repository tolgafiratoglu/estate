...
@section('content')
    <input type="hidden" id="item_id" value='{{ $data["id"] ? $data["id"] : 0 }}'>
    ...
    <div class="form-group">
        ...
        <input type="text" value='{{ $data["name"] ? $data["name"] : "" }}' class="form-control" id="property_status_name" aria-describedby="propertyStatusHelp" placeholder="{{ __('admin.should_not_be_empty') }}">
    ...
    <div class="form-group">
        ...
        <input type="text" value='{{ $data["slug"] ? $data["slug"] : "" }}' class="form-control" id="property_status_slug" aria-describedby="propertyStatusHelp" placeholder="{{ __('admin.optional') }}">
